          ...
          <div className="flex gap-3 pt-1">
            {sosmed.map((item) => (
              <Link
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-gray-700 bg-neutral-900/70 text-gray-300 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-emerald-600/50 hover:text-black hover:bg-custom"
              >
                {item.icon}
              </Link>
            ))}
        ...
        <div className="space-y-4">
          ...
          <form className="space-y-3">
            <Input
              ...
              className=" rounded-full border-gray-700 bg-neutral-900/70 text-sm placeholder:text-gray-500 focus-visible:ring-emerald-500"
            />
            <Button
              type="submit"
